...
public class InTheaterAdapter extends RecyclerView.Adapter<InTheaterAdapter.MyViewHolder> {

    private List<InTheater> images;
    ...
    public InTheaterAdapter(Context context, List<InTheater> images) {
        mContext = context;
        this.images = images;
    }
    ...
    public void onBindViewHolder(MyViewHolder holder, int position) {
        final InTheater image = images.get(position);
    ...
    public static class RecyclerTouchListener implements RecyclerView.OnItemTouchListener {
        ...
        private InTheaterAdapter.ClickListener clickListener;

        public RecyclerTouchListener(Context context, final RecyclerView recyclerView, final InTheaterAdapter.ClickListener clickListener) {
